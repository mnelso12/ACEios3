...
class FirstViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func getMostRecentNews() {
        let url = URL(string: "http://ace.nd.edu/index.php/Request-end-point?action=get&module=zoo&app=4&resource=items&category=asdf&limit=10&api_key=TUMLWASSVI4IR0CR2GHG")
    ...
    func getNews(newsID: String) {
        let urlString = "http://ace.nd.edu/index.php/Request-end-point?action=get&module=zoo&resource=items&app=8&api_key=TUMLWASSVI4IR0CR2GHG&id=" + newsID
    ...
    func getMostRecentBlogs() {
        ...
        let url = URL(string: "http://ace.nd.edu/index.php/Request-end-point?action=get&module=zoo&app=8&resource=items&category=blog&limit=10&api_key=TUMLWASSVI4IR0CR2GHG")
    ...
    func getBlog(blogID: String) {
        let urlString = "http://ace.nd.edu/index.php/Request-end-point?action=get&module=zoo&resource=items&api_key=TUMLWASSVI4IR0CR2GHG&app=8&id=" + blogID
        let url = URL(string: urlString)
