...
class ApplicationChecklistViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var titles = ["1. Application Type and Term", "2. Test Scores", "3. Academic History", "4. Additional Information", "5. Reference Letters", "6. Downloadable Forms", "7. Uploads", "8. Signature", "9. Review"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            cell.textLabel?.text = desc[index]
        case 1:
